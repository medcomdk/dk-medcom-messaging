...
Alias: $activityCodes = http://medcomfhir.dk/fhir/dk-medcom-terminology/CodeSystem/medcom-messaging-activityCodes
Alias: $MessageTypes = http://medcomfhir.dk/fhir/dk-medcom-terminology/ValueSet/medcom-messaging-messageTypes
Alias: $ActivityCodesValueset = http://medcomfhir.dk/fhir/dk-medcom-terminology/ValueSet/medcom-messaging-activityCodes